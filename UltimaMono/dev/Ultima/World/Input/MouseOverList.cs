            ...
            else if (Entity is Item)
            {
                ...
                if (Texture.Bounds.Contains(new Point(x, y)))
                {
                    if (Texture.Width >= 3 && Texture.Height >= 3)
                    {
                        ...
                        if ((pixelData[1].PackedValue > 0) || (pixelData[3].PackedValue > 0) ||
                            (pixelData[4].PackedValue > 0) || (pixelData[5].PackedValue > 0) ||
                            (pixelData[7].PackedValue > 0))
                        {
                    ...
                    else
                    {
                        ...
                        Texture.GetData<Color>(0, new Rectangle(x, y, 1, 1), pixelData, 0, 1);
