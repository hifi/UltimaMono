...
namespace UltimaXNA.Ultima.Resources
{
    class ArtMulResource
    {
        ...
        private unsafe Texture2D ReadLandTexture(int index)
        {
            ...
            Texture2D texture = new Texture2D(m_Graphics, 44, 44, false, SurfaceFormat.Color);
            texture.SetData<int>(UltimaMono.TextureConv.Bgra5551ToArgb32(44, 44, pixels));
        ...
        private unsafe void ReadStaticTexture(int index, out Texture2D texture, out Pair<int> dimensions)
        {
            ...
            texture.SetData<int>(UltimaMono.TextureConv.Bgra5551ToArgb32(width, height, pixels));
