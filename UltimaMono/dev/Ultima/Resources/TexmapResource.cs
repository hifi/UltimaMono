...
namespace UltimaXNA.Ultima.Resources
{
    class TexmapResource
    {
        ...
        private unsafe Texture2D readTexmapTexture(int index)
        {
            ...
            Texture2D texture = new Texture2D(m_Graphics, textureSize, textureSize, false, SurfaceFormat.Color);

            texture.SetData<int>(UltimaMono.TextureConv.Bgra5551ToArgb32(textureSize, textureSize, pixelData));
